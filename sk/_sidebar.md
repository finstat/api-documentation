...
- [Doplnkové  API](sk/additional.md)
    - [Autologin API](sk/additional/autologin.md)
    - [API na synchronizáciu portfólia](sk/additional/monitoring.md)
        - [IČO](sk/additional/monitoring-ico.md)
        - [Dátumy narodenia](sk/additional/monitoring-dates.md)
    - [Autocomplete API](sk/additional/autocomplete.md)
    - [API na vyhľadávanie exekúcií](sk/additional/distraints.md)
